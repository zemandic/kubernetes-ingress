...
def create_ingress_controller(v1: CoreV1Api, apps_v1_api: AppsV1Api, cli_arguments, namespace, args=None) -> str:
    ...
    dep["spec"]["template"]["spec"]["initContainers"][0]["image"] = cli_arguments["image"]
    dep["spec"]["template"]["spec"]["initContainers"][0]["imagePullPolicy"] = cli_arguments["image-pull-policy"]
